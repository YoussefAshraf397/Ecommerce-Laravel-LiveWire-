                                            ...
                                            @if(\Illuminate\Support\Facades\Auth::user()->utype === 'ADM')
                                                <li class="menu-item menu-item-has-children parent" >
                                                    ...
                                                    <ul class="submenu fa-dashboard" >
                                                        ...
                                                        <li class="menu-item">
                                                            <a title="sliders" href="{{route('admin.homeslider')}}">Home Sliders</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a title="mange home categories" href="{{route('admin.homecategories')}}">Home Categories</a>
                                                        </li>
                                                        <li class="menu-item">
                                                        ...
                                                        <li class="menu-item">
                                                            <a title="contacts" href="{{route('admin.contact')}}">All Contact Messages</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a title="SETINGS" href="{{route('admin.settings')}}">All settings</a>
                                                        </li>
...
<script src="https://cdn.tiny.cloud/1/4qjgvo6hef3sc3t2msvgv6vxmkbj3e8p6o9r48gmvmvigthd/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
@livewireScripts
