...
<div class="container">
    <div class="wrap-breadcrumb">
        <ul>
            ...
            <li class="item-link"><span>Wishlist Products</span></li>
        </ul>
    </div>
    <style>
        .product-wish{
                ...
                <li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
                    <div class="product product-style-3 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <a href="#" class="btn add-to-cart" wire:click.prevent="moveProductFromWishlistToCart('{{$item->rowId}}')">Mpve To Cart</a>
