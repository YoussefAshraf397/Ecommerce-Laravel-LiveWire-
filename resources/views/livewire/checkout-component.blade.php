<main id="main" class="main-site">
    ...
    <style>
        .summary-item .row-in-form input[type=password], .summary-item .row-in-form input[type=number] {
            font-size: 13px;
            line-height: 19px;
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form fill-wife">
                                    <label class="checkbox-field">
                                        <input name="different-add" id="different-add" value="1" type="checkbox" wire:model="shipp_to_different">
                    ...
                    @if($shipp_to_different)
                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    <label for="phone">Line 1<span>*</span></label>
                                    <input  type="text" name="line1" value="" placeholder="Line 1" wire:model="s_line1">
                                      @error('s_line1') <span class="text-danger">{{$message}}</span> @enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="phone">Line 2<span>*</span></label>
                                    <input  type="text" name="line2" value="" placeholder="Line 2" wire:model="s_line2">
                        ...
                        @if($paymentmode == 'card')
                            <div class="wrap-address-billing">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input  type="text" name="card-o" value="" placeholder="Card Number" wire:model="card_no">
