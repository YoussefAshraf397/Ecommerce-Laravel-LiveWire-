                        ...
                        <div class="tab-content-item active" id="digital_1a">
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
                                @foreach($latestProducts as $latestProduct)
                                    <div class="product product-style-2 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="{{route('product.detail' ,['slug' => $latestProduct->slug ])}}" title="{{$latestProduct->name}}">
                            ...
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
                                ...
                                @endphp
                                    @foreach($category_products as $category_product)
                                            <div class="product product-style-2 equal-elem ">
                                                <div class="product-thumnail">
                                                    <a href="{{route('product.detail' ,['slug' => $category_product->slug ])}}" title="{{$category_product->name}}">
                                                        <figure><img src="{{asset('assets/images/products'.'/'.$category_product->image)}}" width="800" height="800" alt="{{$category_product->name}}"></figure>
                                                    </a>
                                                </div>
                                                <div class="product-info">
                                                    <a href="{{route('product.detail' ,['slug' => $category_product->slug ])}}" class="product-name"><span>{{$category_product->name}}</span></a>
